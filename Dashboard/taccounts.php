...
// Fetch the teacher's record from the database
...
<div class="horizontal-scroll-wrapper" style="overflow-x: auto; padding-bottom: 10px;">
    <div class="d-flex justify-content-between" style="gap: 20px; min-width: 700px;">
        ...
        <div class="card" style="width: 40%;">
            <img src="<?php echo $user['profile_picture'] ?: '../images/account.png'; ?>"
                 alt="Profile Picture"
            ...
            <div class="card-body text-center">
                ...
                <form action="taccounts_db.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
        ...
        <div class="card" style="width: 60%;">
            <div class="card-body">
                ...
                <form action="taccounts_db.php" method="POST">
                    <div class="mb-3">
