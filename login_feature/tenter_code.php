...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $stmt = $pdo->prepare("SELECT reset_code FROM teacher WHERE email= ?");
    $stmt->execute([$email]);
    ...
    if($user){
        ...
        if($enteredCode === $user['reset_code']){
            ...
            header('Location: treset_password.php');
            exit();
        }else{
...
<html>
   ...
   <img src = "/proto/Entrep_prototype/images/logo1.png" style="width: 150px; height: 150px; margin-top: 20px; margin: 0 auto; "alt = "this is the logo">
            ...
            <form action="tenter_code.php" method="POST" style="width:50%;  margin: auto; ">
