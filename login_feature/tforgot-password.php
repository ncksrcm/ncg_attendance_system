...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($user) {
        ...
        $update = $pdo->prepare("UPDATE teacher SET reset_code = ? WHERE email = ?");
        ...
        try{
            ...
            header('Location: tenter_code.php ');
            exit();

        } catch (Exception $e){
            $_SESSION['error'] = "Message could not be sent";
            header('Location: tforgot-password.php');
            exit();
...
<body>
   ...
   <img src = "/proto/Entrep_prototype/images/logo1.png" style="width: 150px; height: 150px; margin: 0 auto; margin-top: 20px;"alt = "this is the logo">
            ...
            <form action="tforgot-password.php" method="POST" style="width:50%;  margin: auto; ">
