...
<body>
   <div class="container">
        ...
        <img src = "/proto/Entrep_prototype/images/logo1.png" style="width: 150px; height: 150px; margin-top: 20px;"alt = "this is the logo">
            ...
            <form action="tsignup_validate.php" method="POST" >
            ...
            <input class="form-control mb-4" type="password" placeholder="Re-Enter Password" name="confirm_password">
            <button class="btn btn-primary w-100" type="submit">Signup</button>
</form> 
            </form>
            <p>Already have an account? <a href="tlogin.php">Login</a></p>
            <script>
